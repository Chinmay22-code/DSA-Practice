...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/sorted-list-to-bst/1?page=6&category=Linked%20List&sortBy=difficulty)

## Solved On
26 Mar 2026 at 02:35 pm

<h2><a href="https://www.geeksforgeeks.org/problems/sorted-list-to-bst/1?page=6&category=Linked%20List&sortBy=difficulty">Sorted Linked List to BST</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 12pt;">Given a Singly Linked List which has data members sorted in ascending order. Construct a&nbsp;Balanced Binary Search Tree&nbsp;which has same data members as the given Linked List.<br><strong>Note: </strong>There might be nodes with the same value.</span></p>
...
<div><span style="font-size: 12pt;">1 ≤ Value of each node ≤ 10<sup>6</sup></span></div>